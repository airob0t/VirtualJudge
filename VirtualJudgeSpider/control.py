from VirtualJudgeSpider.spiders.HDUSpider import HDU
from VirtualJudgeSpider.spiders.POJSpider import POJ
...
class Controller:
    ...
    # 获取下一个题目id
    @staticmethod
    def get_next_problem_id(oj_name):
        oj = OJBuilder.build_oj(oj_name)
        return oj.get_next_problem_id()
